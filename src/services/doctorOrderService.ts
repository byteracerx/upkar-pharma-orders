      ...
      const processedOrder: Order = {
        ...
        doctor: {
          ...
          name: doctorData && typeof doctorData === 'object' && 'name' in doctorData 
                ? String(doctorData && typeof doctorData === 'object' ? ((doctorData as any).name || "Unknown") : "Unknown") 
                : "Unknown",
          phone: doctorData && typeof doctorData === 'object' && 'phone' in doctorData 
                ? String(doctorData && typeof doctorData === 'object' ? ((doctorData as any).phone || "N/A") : "N/A") 
                : "N/A",
          email: doctorData && typeof doctorData === 'object' && 'email' in doctorData 
                ? String(doctorData && typeof doctorData === 'object' ? ((doctorData as any).email || "") : "") 
                : ""
        }
      };
