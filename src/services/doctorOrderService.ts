      ...
      const processedOrder: Order = {
        ...
        doctor: {
          ...
          name: doctorData && typeof doctorData === 'object' && 'name' in doctorData 
                ? String(doctorData && (doctorData as any).name !== null ? (doctorData as any).name : "Unknown") 
                : "Unknown",
          phone: doctorData && typeof doctorData === 'object' && 'phone' in doctorData 
                ? String(doctorData && (doctorData as any).phone !== null ? (doctorData as any).phone : "N/A") 
                : "N/A",
          email: doctorData && typeof doctorData === 'object' && 'email' in doctorData 
                ? String(doctorData && (doctorData as any).email !== null ? (doctorData as any).email : "") 
                : ""
        }
      };
