        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="bg-white rounded-lg shadow-md p-6 mb-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-upkem-green/10 p-3 rounded-full mr-4">
                    <MapPin className="h-6 w-6 text-upkem-green" />
                  </div>
                  <div>
                    <h3 className="font-medium text-lg">Our Location</h3>
                    <p className="text-gray-600">123 Pharma Street, Medical District</p>
                ...
                <div className="flex items-start">
                  <div className="bg-upkem-green/10 p-3 rounded-full mr-4">
                    <Phone className="h-6 w-6 text-upkem-green" />
                  </div>
                  <div>
                ...
                <div className="flex items-start">
                  <div className="bg-upkem-green/10 p-3 rounded-full mr-4">
                    <Mail className="h-6 w-6 text-upkem-green" />
                  </div>
                  <div>
                    <h3 className="font-medium text-lg">Email Address</h3>
                    <p className="text-gray-600">info@upkarpharma.com</p>
                    <p className="text-gray-600">support@upkarpharma.com</p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <div className="bg-upkem-green/10 p-3 rounded-full mr-4">
                    <Clock className="h-6 w-6 text-upkem-green" />
                  </div>
                  <div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 mb-4">Stay connected with us on social media for updates and announcements.</p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-upkem-green hover:bg-upkem-green/90"
